    ...
    <div className="min-h-screen font-sans flex flex-col items-center py-10" style={{ background: 'var(--background)' }}>
      ...
      <div className="mb-6 w-full max-w-xl card">
        ...
        <select
          ...
          value={selectedBreed}
          onChange={e => { setSelectedBreed(e.target.value); setTypedBreed(""); }}
          list="breed-list"
        >
        ...
        <input
          ...
          type="text"
          value={typedBreed}
          onChange={e => { setTypedBreed(e.target.value); setSelectedBreed(""); }}
          placeholder="Or type a breed name..."
          list="breed-list"
          autoComplete="on"
        />
        ...
        {typedBreed && suggestedBreed && (
          <div className="text-sm text-orange-700">Did you mean: <span className="font-semibold">{suggestedBreed}</span>?</div>
        )}
      </div>
      <div className="mb-6 w-full max-w-xl card">
        ...
        >
          <option value="">-- Select a question or type below --</option>
        ...
        <div className="text-xs text-red-600 mt-2">Note: Answers are AI-generated and may not be accurate. (No real LLM is used yet.)</div>
      </div>
      {answer && (
